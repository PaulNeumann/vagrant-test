...
##### THIS IS A PREVIEW RELEASE ONLY. It uses Oracle Database 19.2, which is available for download from the Oracle Software Delivery Cloud. Oracle Database 19.2 is not supported except on Exadata. This box will change when Oracle Database 19c is released for on-premise use.
...
3. Download the installation zip file from the Oracle Software Delivery Cloud into this folder - first time only:
